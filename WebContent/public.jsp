...
<%@page import="com.ftc.vo.User"%>
<%@ taglib prefix="c" uri="http://java.sun.com/jstl/core"  %>
<%@ page import="com.ftc.constant.*"%>
<%
	...
	String imgPath="";//SystemUtils.getSystemAttribute("imgPath");
 	...
 	String taskStat = ""; 
 	String lossManNme = "";	
 	User user =(User) session.getAttribute(WebConstants.USER_INFO);
...
<script type="text/javascript" src="<%=context%>/javascript/datepicker/TaskRemainder.js"></script>
